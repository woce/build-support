...
* @author Vitaly
* 
* @version  0.1  2009-05-15  <vmk>  Initial version
*******************************************************************************
*/
 ...
 * constructor).
 * 
 * @example struct json_object_iterator iter =
 *             json_object_iter_init_default()
 * @example MyClass() : iter_(json_object_iter_init_default())
 * 
 ...
 * 
 * @example * struct json_object_iterator it;
 ...
 *          * }
 *
 * @example * struct json_object* obj = json_tokener_parse(
 *          *        "{'first':'george', 'age':100}");
